...
const format = winston.format.combine(
  ...
  winston.format.printf(({ timestamp, level, message, component, data, correlationId }) => {
...
export const log = {
  ...
  risk: (message: string, data?: any) => logger.warn(message, { component: "RISK", data }),

  position: (message: string, data?: any) => logger.info(message, { component: "POSITION", data }),
